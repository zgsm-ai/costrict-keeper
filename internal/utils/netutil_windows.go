...
// checkPortConnectable checks if a port is connectable on localhost (Windows implementation)
...
// checkPortListenable checks if a port is listenable (Windows implementation)
